                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top" class="csm-choose-page" style="display:<?php echo $csm_mode == 'live' ? 'none' : 'table-row'; ?>">
                            ...
                            <select multiple="multiple" id="csm_page" name="csm_page[]">
								...
								$selected=(array) get_option('csm_show_page');
								$selected1=(array)get_option('csm_page');
								$f=array_merge($selected,$selected1);
                            ...
                            <p class="description">The site visitors will be able to access selected page if Coming Soon mode is active.</p>
                            </td>
                        </tr>
...
<th scope="row">Page Appearance</th>
<td>
<?php 
$loadonly_content=get_option('csm_appearance');
?>
<label><input type="radio" class="dis_more_option" name="csm_appearance" value="loadonly_content" <?php echo $loadonly_content == 'loadonly_content' ? 'checked':''; ?> /> <?php _e('Display Page Content Only', 'csm')?></label><br /><p></p>
<label><input type="radio" class="dis_more_option" name="csm_appearance" value="dis_more_option" <?php echo $loadonly_content == 'dis_more_option' ? 'checked':''; ?> /> <?php _e('More Custom Options', 'csm')?></label>									
